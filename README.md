...
This is the frontend UI for the WOPR demo. To start it, simply run:
...
An optional "dark mode" can be enabled by setting an environment variable before running the server:

```
export REACT_APP_MODE=dark
```
